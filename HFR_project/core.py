...
def Destaggering(date_in, date_fin, path_to_mod_output_arr, path_to_destag_output_folder_arr, name_exp, time_res, path_to_mask_arr):
    ...
    for i, (path_to_mod_output, path_to_destag_output_folder, path_to_mask) in enumerate(zip(path_to_mod_output_arr,path_to_destag_output_folder_arr, path_to_mask_arr)):
        ...
        for single_date in daterange(start_date, end_date, time_res[i][-1]):
            ...
            u_filename = name_exp[i] + "_" + time_res[i] + "_" + timetag + "_grid_U.nc"
            v_filename = name_exp[i] + "_" + time_res[i] + "_" + timetag + "_grid_V.nc"
            ...
            if time_res[i] == "1d":
                ...
                destaggered_U_current.to_netcdf(path_to_destag_output_folder + name_exp[i] + "_" + time_res[i] + "_" + timetag + "_grid_U2T.nc")
                ...
                print(path_to_destag_output_folder + name_exp[i] + "_" + time_res[i] + "_" + timetag + "_grid_V2T.nc")
                destaggered_V_current.to_netcdf(path_to_destag_output_folder + name_exp[i] + "_" + time_res[i] + "_" + timetag + "_grid_V2T.nc")
